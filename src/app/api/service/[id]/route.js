...
export async function PUT(request, { params }) {
  ...
  if (estimated_time || end_time) {
    ...
    const conditions = [
      ...
      { condition: end_time && (isBefore(new Date(end_time), startTime)), message: 'Waktu selesai tidak valid' },
      { condition: end_time && status !== 'finished' || !status, message: 'Status masih belum Selesai'},
    ]
